...
def auth_function_update_user(adminEmail, adminPassword, firstName, lastName, userId='3'):
    s = requests.Session()
    response = s.post(
...
# print(auth_function_update_list_author('bogosavacm@yahoo.com', 'bogi123', 'Zil', 'Vern', date, 'create', '8'))
...
# date = datetime.date(1942, 2, 25)
# print(auth_function_update_list_book('bogosavacm@yahoo.com', 'bogi123', '20000 milja po morem', date, 289, 4, 'update', '5'))
# # chek if user has permissionss
# print(auth_function_update_list_book('bogi_novi@yahoo.com', 'bogi$$1977', '20000 milja po morem', date, 289, 4, 'update', '5'))
...
# print(auth_function_update_list_borrower_book('bogosavacm@yahoo.com', 'bogi123', 3, 2, 'create', '2'))
